...
def CustomMeta(savePath, jmpBuildDate, addinState, ver_num, author, addinid, addinname):
    '''
...
def main():
    ...
    # write the Custom Meta Data, Addin.def and JMP.cust files to the addin location.
    CustomMeta(zip_location, jmp_date, deployment_stage, ver_num, AUTHOR, ADDIN_ID, ADDIN_NAME)
